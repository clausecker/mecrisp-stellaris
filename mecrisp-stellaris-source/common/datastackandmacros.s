...
.macro Dictionary_Welcome
  Wortbirne Flag_invisible, "--- Mecrisp-Stellaris RA 3.0.2 ---"
.endm

.macro welcome Meldung
  bl dotgaensefuesschen
        .byte 8f - 7f         @ Compute length of name field.
7:      .ascii "Mecrisp-Stellaris RA 3.0.2"
        .ascii "\Meldung\n"
8:      .p2align 1
.endm
...
.macro Dictionary_Welcome
  Wortbirne Flag_invisible, "--- Mecrisp-Stellaris 3.0.2 ---"
.endm

.macro welcome Meldung
  bl dotgaensefuesschen
        .byte 8f - 7f         @ Compute length of name field.
7:      .ascii "Mecrisp-Stellaris 3.0.2"
        .ascii "\Meldung\n"
8:      .p2align 1
.endm
